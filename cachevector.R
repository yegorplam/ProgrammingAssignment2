...
# to create a special object that stores a numeric vector and cache's its mean.
# 
# 
# The first function, makeVector creates a special "vector", which is really 
# a list containing a function to 1.set the value of the vector
...
# mean of the data and sets the value of the mean in the 
